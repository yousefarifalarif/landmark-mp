...
good_adj = ["great", "lovely", "perfect", "amazing", "cool"]
bad_adj = ["awful", "unpleasant", "bad", "terrible", "nasty"]
...
puts "Creating Berlin landmarks, bookings and reviews..."
landmarks = [
...
landmarks.each do |item|
  ...
  2.times do
    ...
    booking = Booking.create!(landmark: landmark, user: user, start_date: rand_st_d, end_date: rand_st_d + rand(1..5),
  ...
  2.times do
    rand_st_d = Date.today + rand(5..30)
    user = [yousef, ethan, katie].sample
    Booking.create!(landmark: landmark, user: user, start_date: rand_st_d, end_date: rand_st_d + rand(1..5),
                    total_price: landmark.price * (rand_ed_d - rand_st_d + 1), state: 'pending')
  end
end

# Create Dubai landmarks
puts "Creating Dubai landmarks, bookings and reviews..."
landmarks = [
...
puts "Creating London landmarks, bookings and reviews..."
landmarks = [
...
puts "Creating Hong Kong landmarks, bookings and reviews..."
landmarks = [
